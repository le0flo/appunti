...
- Si parte da una situazione stabile, dove lo stato presente è uguale allo stato futuro
- Cambia un ingresso
- Dopo un tempo pari al ritardo della rete, sono disponibili un nuovo stato futuro e una nuova uscita.
- Lo stato futuro diventa lo stato presente, sovrascrivendolo nella memoria della rete.
- Nuova situazione stabile, con uno stato presente uguale allo stato futuro, ed un ingresso costante.
...
Però i gate non sono istantanei, ogni gate reale ha un ritardo di propagazione, indicato dal tempo $tau_p$.
...
- $F: S times I arrow U$: funzione di uscita,
- $G: S times I arrow S$: funzione di aggiornamento dello stato interno
...
- Tabella della verità (TdV) $arrow$ Comportamento della rete
- Espressione o schema logico $arrow$ Struttura della rete
...
Quando il valore d'uscita cambia tra due stati, bisogna contrassegnare l'uscita nella transazione con il simbolo di indifferenza.
Per progettare una RSA che opera con continuità, bisogna assicurarsi che:
...
+ Partiamo dallo stato presente stabile B con gli ingressi $y_1y_0 = 11$
+ Appena cambiamo ingressi $y_1y_0 = 10$, lo stato immediatamente futuro è D
